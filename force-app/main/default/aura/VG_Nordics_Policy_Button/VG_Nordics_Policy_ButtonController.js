({
    ...
    handlePTClick: function(component, event, helper){
        var recordId=component.get('v.recordId');
        console.log(recordId)
        var CC=component.get('v.CurCode');
         var url='/sfdcpage/'+encodeURIComponent('/apex/VG_PolicyPaymentTaxLWC?id=')+recordId+encodeURIComponent('&Currency=')+CC;
        var urlEvent = $A.get("e.force:navigateToURL");
        urlEvent.setParams({
            "url": url
        });
                            ...
                            function(response){
                                if(response.getState() == "SUCCESS"){
                                    ...
                                    toastEvent.setParams({
                                        "title": "Success!",
                                        "type": "success",
                                        "message": "BS_English_Quote_Sheet Attachment added to the Policy Successfully."
                                    });
                                    toastEvent.fire();                                                                        
                                }
                            }
                            ...
                            function(response){
                                if(response.getState() == "SUCCESS"){
                                    ...
                                    toastEvent.setParams({
                                        "title": "Success!",
                                        "type": "success",
                                        "message": "BS_Swedish_Quote_Sheet Attachment added to the Policy Successfully."
                                    });
                                    toastEvent.fire(); 
                                }
                            }
                           ...
                           function(response){
                               if(response.getState() == "SUCCESS"){
                                   ...
                                   toastEvent.setParams({
                                       "title": "Success!",
                                       "type": "success",
                                       "message": "BS_English Policy Schedule Attachment added to the Policy Successfully."
                                   });
                                   toastEvent.fire(); 
                               }
                           }
                           ...
                           function(response){
                               if(response.getState() == "SUCCESS"){
                                   ...
                                   toastEvent.setParams({
                                       "title": "Success!",
                                       "type": "success",
                                       "message": "BS_Swedish Policy Schedule Attachment added to the Policy Successfully."
                                   });
                                   toastEvent.fire(); 
                               }
                           }
                           ...
                           function(response){
                               if(response.getState() == "SUCCESS"){
                                   ...
                                   toastEvent.setParams({
                                       "title": "Success!",
                                       "type": "success",
                                       "message": "Bridge English Invoice Attachment added to the Policy Successfully."
                                   });
                                   toastEvent.fire(); 
                               }
                           }
                           ...
                           function(response){
                               if(response.getState() == "SUCCESS"){
                                   ...
                                   toastEvent.setParams({
                                       "title": "Success!",
                                       "type": "success",
                                       "message": "Bridge Swedish Invoice Attachment added to the Policy Successfully."
                                   });
                                   toastEvent.fire(); 
                               }
                           }
    ...
    doInit : function(component, event, helper) {
        ...
        action.setCallback(this, function(response) {
            ...
            if(state=="SUCCESS"){
                ...
                if(pol.Policy_Status__c == 'Bound' || pol.Policy_Status__c=='Booked'){   
                    component.set("v.bound", true);
                }
                if(pol.Line_Of_Business__c == 'Commercial Combined'){
                    component.set("v.ccProduct", true);
                }
            }else{
