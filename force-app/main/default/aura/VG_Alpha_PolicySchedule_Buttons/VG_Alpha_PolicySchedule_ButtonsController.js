({
    doInit  : function(component, event, helper) {
        ...
        action.setCallback(this, function(response) {
            ...
            if(state=="SUCCESS"){
                ...
                if(ps.VG_Status__c !='Booked' && ps.VG_Is_MTA__c && (ps.VG_MTA_Type__c=='Revision of Cover'||ps.VG_MTA_Type__c=='Extension'||ps.VG_MTA_Type__c=='Cancellation'||ps.VG_MTA_Type__c=='Declaration' || ps.VG_MTA_Type__c=='Reinstatement Premium' || ps.VG_MTA_Type__c=='Bad Debt Provision')){
    ...
    handleReviseClick : function(component, event, helper) {
        ...
        if(MTAType == "Bad Debt Provision"){
            var url='/sfdcpage/'+encodeURIComponent('/apex/VG_Revise_Alpha_Step4?Id=')+recordId;
        }else{  
