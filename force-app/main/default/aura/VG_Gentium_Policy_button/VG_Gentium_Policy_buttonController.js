({
    ...
    gotoBasePolicy : function(component, event, helper) {
        ...
        action.setCallback(this, function(response) {
            ...
            if(state=="SUCCESS" && basePolicyId != null){
                window.open('/VIM/s/policy/'+basePolicyId,'_blank');
    ...
    checkPolicyAssets : function(component, event, helper) {
        ...
        urlEvent.fire(); */
        window.open('/VIM/s/sfdcpage/'+encodeURIComponent('/apex/VG_Show_Policy_Assets?id=')+recordId,'_blank','height=500px,top=200px,width=700px;');
    },
