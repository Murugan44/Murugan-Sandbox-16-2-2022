({
    ...
    handleReviseClick : function(component, event, helper) {
        ...
        if(MTAType == "Bad Debt Provision"){       
            if(!product.includes('Commercial Combined')){
              //  alert('Not')
                var url='/sfdcpage/'+encodeURIComponent('/apex/VG_Revise_Nordics_Step5?PSId=')+recordId+encodeURIComponent('&policyCurrency=')+policyCurrency;            
            }else{
               // alert('Yes')
               var url='/sfdcpage/'+encodeURIComponent('/apex/VG_CC_Revise_Nordics_Step6?PSId=')+recordId+encodeURIComponent('&policyCurrency=')+policyCurrency;
            }
        }else{
            if(!product.includes('Commercial Combined')){
               // alert('Not 2')
               ...
               // alert('Yes 2')
               console.log('check:'+component.get("v.psProduct"));
    ...
    handleROCClick : function(component, event, helper) {
        var status;
        var recordId=component.get('v.recordId');
        var url='/sfdcpage/'+encodeURIComponent('/apex/VG_MTA_Step1?PSId=')+recordId+encodeURIComponent('&RecordType=Bridge');
        var urlEvent = $A.get("e.force:navigateToURL");
        urlEvent.setParams({
            "url": url
        });
