({
    handleClick : function(component, event, helper) {
        ...
        var url='/sfdcpage/'+encodeURIComponent('/apex/VG_VCL_AssetsUpload?id=')+recordId+encodeURIComponent('&attType=Assets File&sObjectType=Account');
    ...
    handleDocClick : function(component, event, helper) {
        var recordId=component.get('v.recordId');
        var url='/sfdcpage/'+encodeURIComponent('/apex/VG_VCL_AssetsUpload?id=')+recordId+encodeURIComponent('&sObjectType=Account');
        var urlEvent = $A.get("e.force:navigateToURL");
        urlEvent.setParams({
            "url": url
        });
    ...
    handlePSClick : function(component, event, helper) {
        var rt=$A.get("$Label.c.VCL_Policy");
        var recordId=component.get('v.recordId');
    ...
    recordUpdate: function(component, event, helper) {
        ...
        //alert(compStatus);
        if(compStatus == 'Potential Match' || compStatus == 'Pending' || compStatus == null || compStatus == 'True Positive' || compStatus == 'True Positive – Reject'){
